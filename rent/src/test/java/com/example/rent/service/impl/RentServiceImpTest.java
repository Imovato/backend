...
//    @Mock
//    private AccommodationServiceImpl propertyService;
//    @Mock
...
////
////        BDDMockito.when(propertyRepositoryMock.save(ArgumentMatchers.any(Accommodation.class)))
...
////        User savedCustomer = customerRepositoryMock.save(CustomerCreator.createCustomer());
////        Accommodation savedProperty = propertyRepositoryMock.save(PropertyCreator.createProperty());
////        BDDMockito.when(customerService.findCustomerById(savedCustomer.getId())).thenReturn(savedCustomer);
////        BDDMockito.when(propertyService.findAccommodationById(savedProperty.getId())).thenReturn(savedProperty);
////
